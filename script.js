...
// Get time remaining span and set to spanTimeRemEle
const spanTimeEle = document.querySelector("#timer");

//! QUIZ ELEMENTS

//! -- QZ0 ELEMENTS -- //
// get qz0 div and set it to qz0DivEle
const qz0DivEle = document.querySelector("#qz0");
// get Start Quiz Button and set it to startBtn 
const startBtn = document.querySelector("#startBtn");

//! -- QZ1 ELEMENTS -- //
// get qz1 div and set it to qz1DivEle
const qz1DivEle = document.querySelector("#qz1");
...
//! -- QZ2 ELEMENTS -- //
// get qz2 div and set it to qz2DivEle
const qz2DivEle = document.querySelector("#qz2");
...
//! -- QZ3 ELEMENTS -- //
// get qz3 div and set it to qz3DivEle
const qz3DivEle = document.querySelector("#qz3");
...
//! -- QZ4 ELEMENTS -- //
// get qz4 div and set it to qz4DivEle
const qz4DivEle = document.querySelector("#qz4");
...
//! -- QZ5 ELEMENTS -- //
// get qz5 div and set it to qz5DivEle
const qz5DivEle = document.querySelector("#qz5");
...
//! -- QZ6 ELEMENTS -- //
// get qz6 div and set it to qz6DivEle
const qz6DivEle = document.querySelector("#qz6");
...
//! -- QZ7 ELEMENTS -- //
// get qz7 div and set it to qz7DivEle
const qz7DivEle = document.querySelector("#qz7");
...
//! -- QZ8 ELEMENTS -- //
// get qz8 div and set it to qz8DivEle
const qz8DivEle = document.querySelector("#qz8");
...
//! -- QZ9 ELEMENTS -- //
// get qz9 div and set it to qz9DivEle
const qz9DivEle = document.querySelector("#qz9");
...
//! -- QZ10 ELEMENTS -- //
// get qz10 div and set it to qz10DivEle
const qz10DivEle = document.querySelector("#qz10");
...
// get qz11 div and set it to qz11DivEle
const qz11DivEle = document.querySelector("#qz11");
