...
const arrQZ1 = {
  // Question #1 Array
  question:
    "Which of the following are not valid events for a .addEventListener method?",
...
const arrQZ2 = {
  // Question #2 Array
  question:
    "Which of the following prevents event bubbling to a parent element?",
...
const arrQZ3 = {
  // Question #3 Array
  question:
    "Which method is unique to arrays and can be used similar to a 'for' loop to act on each index and item in an array?",
...
const arrQZ5 = {
  // Question #5 Array
  question:
    "Which of the following methods would you use to create a loop based on time elapsing?",
...
const arrQZ6 = {
  // Question #6 Array
  question:
    "Which of the following would return the item in the first index position of an array call 'items'?",
...
const arrQZ7 = {
  // Question #7 Array
  question:
    "Which of the following methods would be used on an array to arrange its items alphabetically?",
...
const arrQZ8 = {
  // Question #8 Array
  question:
    "Which string method would you use to remove excess whitespace from both sides of a string?",
...
const arrQZ10 = {
  // Question #10 Array
  question:
    "If given a variable equal to '10', which method would you use to convert the '10' string to the number 10?",
